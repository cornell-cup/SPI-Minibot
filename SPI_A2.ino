...
Stepper stepper(stepsPerRevolution, A1, 7, 3, 2);
Stepper rstepper(stepsPerRevolution, 2,3,7,A1);
Stepper stepper2(stepsPerRevolution, A2, A4, 5, 8);
Stepper rstepper2(stepsPerRevolution, 8,5,A4,A2);
